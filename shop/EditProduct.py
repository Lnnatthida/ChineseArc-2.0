...
class UpdateProductForm(Form):
    ...
    produt_name = TextAreaField('Product Name', validators=[DataRequired()])
    product_category = TextAreaField('Product Category', validators=[DataRequired()])
    product_price= TextAreaField('Product Price', validators=[DataRequired()])
    product_description= TextAreaField('Product Description', validators=[DataRequired()])
    product_stock= TextAreaField('Product Stock', validators=[DataRequired()])
